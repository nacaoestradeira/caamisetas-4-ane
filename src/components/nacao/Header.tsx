const Header = () => (
  <div className="relative overflow-hidden border-b-2 border-gold bg-gradient-to-b from-[#000] via-[#0e0800] to-[#1a0f00] px-5 pb-6 pt-8 text-center">
    ...
    />
    <p className="font-oswald text-[13px] font-light tracking-[4px] uppercase text-gold mb-3.5">Junho 2026 · Teresina/PI</p>
    <h1 className="font-bebas text-[clamp(22px,6vw,36px)] tracking-wider leading-tight text-foreground relative z-10">
      Camisetas do 4º Aniversário{' '}
      <em className="not-italic bg-gradient-to-br from-gold via-gold-shine to-gold bg-clip-text text-transparent">Nação Estradeira</em>
    </h1>
    <p className="relative z-10 mt-2.5 text-[13px] text-[#9a8a6a] leading-relaxed max-w-[380px] mx-auto">
      Preencha o formulário abaixo para garantir suas camisetas do encontro. Cada participante pode pedir várias unidades.
    </p>
